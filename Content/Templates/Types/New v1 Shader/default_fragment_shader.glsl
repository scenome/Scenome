...
void main(void)
{
   ...
   // Render
   diffuse *= ( tintColor * tintAmount ) * vec4( light.rgb, 1.0 ) * light;
   // This function call MUST be the last thing you do to whatever color you are assigning to fragColor.
